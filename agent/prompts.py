...
1. **AGENTS.md** - 你的角色定義和工作流程（只讀參考
2. **CHECKLIST.md** - 快速進度儀表板（每輪迭代必更新
   * 格式：目標、環境、進度 checklist（- [ ]/- [x]）、本輪迭代摘要
3. **plan.md** - 詳細重構計劃和 TDD 循環記錄（每輪迭代必更新)
   * 格式：Phase 劃分、具體任務步驟、技術決策記錄
4. **learnings.md** - 錯誤模式知識庫（長期累積，可選）
